...
// load aws config
//aws.config..lo loadFromPath(__dirname + '/config/aws-config.json')
aws.config.sqs = { 'endpoint': process.env.SQS_ENDPOINT }
aws.config.sns = { 'endpoint': process.env.SNS_ENDPOINT  }
